...
mass = 21000
state_space = 16
actions_space = 3  # TODO: Qua potrei incrementare peso su constraint
...
model = RecurrentPPO.load(
    ...
    custom_objects={"learning_rate": 1e-5, "ent_coeff": 0},
)  # tensorboard_log="some_name"
check_env(env)
print(model.policy)
model.set_env(env)
...
model = RecurrentPPO.load("ppo_recurrent200")
obs = env.reset()
