...
model = RecurrentPPO.load("ppo_recurrentCost")
obs = env.reset()
...
plt.savefig("plots\TrajectoryCost.pdf")  # Save
...
plt.savefig("plots\VelocityCost.pdf")  # Save
...
plt.savefig("plots\PositionCost.pdf")  # Save
...
plt.xlabel("Time [s]")
plt.ylabel("Mass [kg]")
plt.savefig("plots\MassCost.pdf")  # Save
...
plt.ylabel("Thrust [N]")
plt.xlim(t[0], t[-1])
plt.savefig("plots\ThrustCost.pdf", bbox_inches="tight")  # Save
...
plt.savefig("plots\AngVelCost.pdf")  # Save
