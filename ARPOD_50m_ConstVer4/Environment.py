...
class ArpodCrtbp(gym.Env):
    ...
    def __init__(
        ...
        self.ang_corr = np.deg2rad(20)  # TODO: puoi provare 20
        self.len_kso_cyl = 5
    ...
    def get_reward(self, T):
        ...
        # Dense reward RVD
        reward = (1 / 50) * np.log(x_norm) ** 2  # TODO: provalo negativa
        ...
        reward += - (1 / 100) * np.exp(T_norm / self.max_thrust) ** 2  # TODO: se funziona proa ad alzare coefficiente
