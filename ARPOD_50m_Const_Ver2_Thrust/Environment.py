...
class ArpodCrtbp(gym.Env):
    ...
    def __init__(
        ...
        self.max_thrust = 3680 / (self.m_star * self.l_star / self.t_star**2)
    ...
    def get_reward(self, T):
        ...
        reward += - (1 / 500) * np.exp(T_norm / self.max_thrust) ** 2
    ...
    def is_outside(self, rho):
        ...
        reward_cons = - (1 / 100) * np.exp(0.5 * const / self.rho_max) ** 2
