...
# Start learning
# model.learn(total_timesteps=3500000, progress_bar=True)
...
# TODO: togliendo thrust e con meno ToF ci mette comunque il meno possibile (fissabile?) ma almeno risparmia dV
